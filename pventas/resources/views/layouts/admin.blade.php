            ...
            <div class="brand-logo">
                <a href="/home">
                    ...
                    <span class="brand-title">
                        <center><h3>Sistema Ventas</h3></center>
                    </span>
                </a>
            </div>
        </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Registro</span>
                        </a>
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Productos</span>
                        </a>
                        <ul aria-expanded="false">
